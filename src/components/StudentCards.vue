...
<template>
  <el-card class="card">
    <el-row>
      <el-text
        style="width: 100%; font-family: regular; font-size: 7px; color: black; text-align: center"
      >
    ...
    <el-row>
      <el-text
        style="font-family: semiBold; font-size: 7px; color: black; width: 100%; text-align: center"
      >
    ...
    <el-row style="margin-top: 10px; justify-content: space-between">
      <el-image :src="schoolLogo" style="width: 45%; height: 45%" fit="cover" />
    ...
    <div style="background-color: #2148c0; border-radius: 10px; padding: 5px; margin-top: 10px">
      <el-row>
        <el-text
          style="
            width: 100%;
